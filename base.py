while True:
    ...
    if x==255 and y==4 and z==19:
        ...
        print(x,"/",y,"R",z)
        s=["Precio: ","ideal para ciudad", "pagina de compra:"]
        print(s)
        ...
        print("Llanta: Goodyear EfficientGrip Performance ROF")
        print(T)
        s=["Precio: ","ideal para ciudad", "pagina de compra:"]
        print(s)
        ...
        print("Llanta: Goodyear Eagle F1 Asymmetric 2")
        print(T)
        s=["Precio: ","ideal para ciudad", "pagina de compra:"]
        print(s)
        print("Control preciso y potente Aproveche al máximo su coche con un neumático fabricado para maximizar el rendimiento de alta potencia. Un compuesto de sílice especial ofrece un agarre fiable en carreteras secas y mojadas con una carcasa rígida que aumenta la precisión de la dirección incluso a alta velocidad.")
    elif x==175 and y==70 and z==13:
        print("Llanta: Direction Touring")
        print(T)
        s=["Precio: ","ideal para ciudad", "pagina de compra:"]
        print(s)
        ...
        print("Llanta: Goodyear EfficientGrip ROF")
        print(T)
        s=["Precio: ","ideal para ciudad", "pagina de compra:"]
        print(s)
        ...
        print("Llanta: Goodyear Eagle F1 Asymmetric")
        print(T)
        s=["Precio: ","ideal para ciudad", "pagina de compra:"]
        print(s)
        ...
        print("Llanta: Goodyear Excellence ROF")
        print(T)
        s=["Precio: ","ideal para ciudad", "pagina de compra:"]
        print(s)
        print("Las plantas automotrices más reconocidas del mercado equipan sus vehículos con llantas que tienen tecnología RunOnFlat®. Esta tecnología permite que la llanta ruede sin presión del aire hasta 80 km/h.")
    elif x==205 and y==60 and z==16:
        print("Llanta: Goodyear EfficientGrip Performance")
        print(T)
        s=["Precio: ","ideal para ciudad", "pagina de compra:"]
        print(s)
        ...
        print("Llanta: Kelly Edge Touring")
        print(T)
        s=["Precio: ","ideal para ciudad", "pagina de compra:"]
        print(s)
        ...
        print("Llanta: Goodyear EfficientGrip")
        print(T)
        s=["Precio: ","ideal para ciudad", "pagina de compra:"]
        print(s)
...
#Siguiente
        ...
        print("Llanta: Goodyear EfficientGrip Performance SUV")
        print(T)
        s=["Precio: ","Camioneta", "pagina de compra:"]
        print(s)
        ...
        print("Llanta: Goodyear Wrangler All-Terrain Adventure")
        print(T)
        s=["Precio: ","Camioneta", "pagina de compra:"]
        print(s)
        ...
        print("Llanta: Goodyear Wrangler MT/R Kevlar")
        print(T)
        s=["Precio: ","Camioneta", "pagina de compra:"]
        print(s)
        ...
        print("Llanta: Goodyear G32 CARGO")
        print(T)
        s=["Precio: ","Camioneta", "pagina de compra:"]
        print(s)
        ...
        print("Llanta: Goodyear Wrangler Duratrac")
        print(T)
        s=["Precio: ","Camioneta", "pagina de compra:"]
        print(s)
        ...
        print("Llanta: Goodyear Wrangler AT/S")
        print(T)
        s=["Precio: ","Camioneta", "pagina de compra:"]
        print(s)
