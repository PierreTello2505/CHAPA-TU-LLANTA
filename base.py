while True:
    ...
    if x==255 and y==4 and z==19:
        ...
        print(x,"/",y,"R",z)
        s=["Precio Aproximado ","ideal para ciudad", "pagina de compra: https://www.goodyear.com.pe/llantas"]
        print(s)
    ...
    #Siguiente
        ...
        print(x,"/",y,"R",z)
        s=["Precio Aproximado ","Camioneta", "pagina de compra: https://www.goodyear.com.pe/llantas"]
        print(s)
    ...
    #Siguiente
        ...
        print(x,"/",y,"R",z)
        s=["Precio aproximado: ","Assurance", "pagina de compra: https://www.goodyear.com.pe/llantas "]
        print(s)
    ...
    #Siguiente
        ...
        print(x,"/",y,"R",z)
        s=["Precio aproximado: ","Eagle", "pagina de compra: https://www.goodyear.com.pe/llantas"]
        print(s)
        ...
        print("Neumatico: Goodyear Excellence ROF")
        print(x,"/",y,"R",z)
        s=["Precio aproximado aproximado: ","Eagle", "pagina de compra: https://www.goodyear.com.pe/llantas"]
        print(s)
    ...
    #Siguiente
        ...
        print("Neumatico: Goodyear Wrangler All-Terrain Adventure")
        print(x,"/",y,"R",z)
        s=["Precio aproximado aproximado: ","Wrangler", "pagina de compra: https://www.goodyear.com.pe/llantas"]
        print(s)
